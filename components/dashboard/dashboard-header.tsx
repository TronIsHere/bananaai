      ...
      <div className="flex items-center justify-between px-4 py-3 md:px-8 md:py-4">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <Link
            ...
            className="flex items-center gap-2 rounded-lg border border-yellow-400/30 bg-yellow-400/10 px-2 py-1.5 transition-all hover:border-yellow-400/50 hover:bg-yellow-400/15 active:scale-95 sm:px-3 md:px-4 md:py-2 cursor-pointer"
          >
            ...
            <div className="text-right">
              ...
              <p className="text-xs font-bold text-yellow-400 sm:text-sm">
