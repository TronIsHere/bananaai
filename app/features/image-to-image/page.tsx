    ...
    <div className="min-h-screen bg-slate-950 text-white" dir="rtl">
      ...
      <main>
        ...
        <section className="relative overflow-hidden py-20 sm:py-32 lg:pb-32 xl:pb-36">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-8 inline-flex items-center rounded-full border border-fuchsia-500/30 bg-fuchsia-500/10 px-3 py-1 text-sm text-fuchsia-300 backdrop-blur-sm">
                <span className="flex h-2 w-2 rounded-full bg-fuchsia-400 mr-2 animate-pulse"></span>
                نسل جدید پردازش تصویر
              </div>
              <h1 className="text-5xl font-black tracking-tight text-white sm:text-7xl bg-clip-text text-transparent bg-gradient-to-b from-white to-white/60 mb-6">
                جادوی تبدیل <br />
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <Link href="/dashboard/image-to-image">
                  <Button className="h-14 px-8 text-lg rounded-2xl bg-fuchsia-600 hover:bg-fuchsia-500 shadow-[0_0_40px_-10px_rgba(192,38,211,0.5)] hover:shadow-[0_0_60px_-10px_rgba(192,38,211,0.6)] transition-all duration-300 group">
                    شروع رایگان
            ...
            <div className="mt-16 flow-root sm:mt-24">
              <div className="relative rounded-xl bg-slate-900/50 border border-white/10 p-2 ring-1 ring-inset ring-white/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                <div className="absolute -inset-4 bg-gradient-to-r from-fuchsia-500 to-purple-600 opacity-20 blur-2xl -z-10 rounded-[3rem]" />
                <div className="grid grid-cols-2 gap-4 md:grid-cols-2 rounded-lg overflow-hidden aspect-[2/1] relative group">
                  {/* Before Image Placeholder */}
                  <div className="relative h-full bg-slate-800 flex items-center justify-center border-r border-white/10 group-hover:w-[45%] transition-all duration-500 ease-out">
                    ...
                    <ImageIcon className="h-16 w-16 text-slate-600 opacity-50" />
                    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=1000&auto=format&fit=crop')] bg-cover bg-center opacity-60 grayscale hover:grayscale-0 transition-all duration-500" />
                  </div>
                  {/* After Image Placeholder */}
                  <div className="relative h-full bg-slate-800 flex items-center justify-center group-hover:w-[55%] transition-all duration-500 ease-out">
                    <div className="absolute top-4 left-4 bg-fuchsia-500/20 backdrop-blur-md px-3 py-1 rounded-full text-xs font-medium border border-fuchsia-500/30 text-fuchsia-200">
                      بعد
                    </div>
                    <Sparkles className="h-16 w-16 text-fuchsia-500 opacity-50" />
                    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=1000&auto=format&fit=crop')] bg-cover bg-center mix-blend-overlay opacity-80 bg-fuchsia-500/30" />
                  ...
                  {/* Interactive Slider Handle (Visual only) */}
                  <div className="absolute inset-y-0 left-1/2 w-1 bg-white/20 backdrop-blur cursor-ew-resize flex items-center justify-center group-hover:left-[45%] transition-all duration-500">
                    <div className="h-8 w-8 rounded-full bg-white shadow-lg flex items-center justify-center text-slate-900">
        ...
        <section className="py-24 sm:py-32 bg-slate-950 relative">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center mb-16">
              <h2 className="text-base font-semibold leading-7 text-fuchsia-400">
                امکانات پیشرفته
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[200px]">
              {/* Feature 1 - Large */}
              <div className="md:col-span-2 row-span-2 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 hover:bg-white/[0.07] transition-colors group">
                <div className="absolute right-0 top-0 h-full w-1/2 bg-gradient-to-l from-fuchsia-500/10 to-transparent" />
                <div className="relative z-10 h-full flex flex-col justify-between">
                  <div className="h-12 w-12 rounded-2xl bg-fuchsia-500/20 flex items-center justify-center mb-4">
              ...
              <div className="rounded-3xl border border-white/10 bg-white/5 p-6 hover:bg-white/[0.07] transition-colors relative overflow-hidden group">
                ...
                <Wand2 className="h-8 w-8 text-purple-400 mb-4" />
              ...
              {/* Feature 4 - Wide */}
              <div className="md:col-span-2 rounded-3xl border border-white/10 bg-white/5 p-8 hover:bg-white/[0.07] transition-colors relative overflow-hidden flex items-center justify-between group">
        ...
        <section className="py-24 bg-slate-950 relative overflow-hidden">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-fuchsia-600/5 rounded-full blur-3xl" />
              ...
              {steps.map((step, index) => (
                <div key={index} className="relative">
                  ...
                  <div className="relative z-10 flex flex-col items-center text-center">
                    <div className="w-24 h-24 rounded-full bg-slate-900 border border-fuchsia-500/30 flex items-center justify-center mb-6 shadow-[0_0_30px_-10px_rgba(192,38,211,0.3)]">
                      <step.icon className="h-10 w-10 text-fuchsia-400" />
                    </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {useCases.map((useCase, idx) => (
                <div
                  key={idx}
                  className="group relative p-6 bg-white/5 rounded-2xl border border-white/10 hover:border-fuchsia-500/50 transition-all duration-300 hover:-translate-y-1"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-fuchsia-500/5 to-transparent opacity-0 group-hover:opacity-100 rounded-2xl transition-opacity" />
                  <div className="relative z-10">
                    <h3 className="text-lg font-semibold text-white mb-2 flex items-center">
                      <span className="w-1.5 h-1.5 rounded-full bg-fuchsia-500 mr-2" />
                      {useCase.title}
                    </h3>
        ...
        <section className="relative py-24 overflow-hidden">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 relative text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/dashboard/image-to-image">
                <Button className="h-14 px-10 rounded-full bg-white text-slate-950 hover:bg-slate-200 font-bold text-lg shadow-xl hover:shadow-2xl transition-all transform hover:scale-105">
                  شروع کنید رایگان
              ...
              <Link href="/#features">
                <Button
                  variant="outline"
                  className="h-14 px-10 rounded-full border-white/20 bg-transparent text-white hover:bg-white/10 font-medium text-lg"
                >
                  بازگشت به خانه
                </Button>
              </Link>
