export const siteConfig = {
  ...
  description:
    "تولید تصویر با هوش مصنوعی نانوبنانا - تبدیل متن به تصویر و تصویر به تصویر با دقت بالا. پلتفرم ایرانی هوش مصنوعی برای خلق تصاویر حرفه‌ای از متن فارسی و انگلیسی. مناسب برای طراحان، فریلنسرها و کسب‌وکارها.",
