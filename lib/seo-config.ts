export const siteConfig = {
  ...
  description:
    "تولید تصویر با هوش مصنوعی نانوبنانا - تبدیل متن به تصویر و تصویر به تصویر با دقت بالاست. یک پلتفرم ایرانی هوش مصنوعی برای خلق تصاویر حرفه‌ای از متن فارسی و انگلیسی که مناسب برای برای طراحان، فریلنسرها و کسب‌وکارها.",
